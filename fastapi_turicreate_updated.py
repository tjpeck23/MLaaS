...
# FastAPI imports
from fastapi import FastAPI, Body, HTTPException, status, UploadFile, Form
...
async def create_datapoint(datapoint: SecretDataPoint = Body(...)):
    """
